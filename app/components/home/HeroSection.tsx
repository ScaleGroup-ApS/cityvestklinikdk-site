...
const HERO_IMAGE = "/images/Forside-specialklinik-Taastrup%20(2).jpg";
    ...
    <section className="relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 md:py-44 w-full">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          >
            Professionel omskæring i trygge rammer. Vi er autoriserede speciallæger med mange års erfaring.
            Vi følger Styrelsen for Patientsikkerheds vejledning og ligger i City Vest i Brabrand ved Aarhus.
          </motion.p>
          ...
          >
            <div className="relative w-full max-w-[520px]">
              ...
              {heroImageError ? (
                <div
                  className="relative z-20 w-full h-[360px] rounded-2xl shadow-2xl flex items-center justify-center bg-gradient-to-br from-primary/20 to-primary/5"
                  aria-hidden
                >
                  <span className="font-heading text-2xl font-medium text-secondary/40 text-center px-4">Kirurgisk klinik Brabrand</span>
                </div>
              ) : (
                <img
                  src={HERO_IMAGE}
                  alt="Kirurgisk klinik Brabrand"
